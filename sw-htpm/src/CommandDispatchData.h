...
#ifndef COMMANDDISPATCHDATA_H
#define COMMANDDISPATCHDATA_H
...
#define TPMI_RH_ENDORSEMENT_H_UNMARSHAL  (TPMI_DH_PCR_H_UNMARSHAL + 1)
    (UNMARSHAL_t)TPMI_RH_ENDORSEMENT_Unmarshal,
...
#define TPMI_RH_ENABLES_P_UNMARSHAL     (TPMI_ECC_KEY_EXCHANGE_P_UNMARSHAL + 1)
    (UNMARSHAL_t)TPMI_RH_ENABLES_Unmarshal,
...
#define TPM2B_KYBER_ENCRYPT_P_UNMARSHAL (TPM2B_KYBER_SHARED_KEY_P_UNMARSHAL)
    (UNMARSHAL_t)TPM2B_KYBER_ENCRYPT_Unmarshal,
#define PARAMETER_LAST_TYPE             (TPM2B_KYBER_ENCRYPT_P_UNMARSHAL)
...
#define TPM2B_KYBER_ENCRYPT_P_MARSHAL (TPM2B_KYBER_PUBLIC_KEY_P_MARSHAL)
    (MARSHAL_t)TPM2B_KYBER_ENCRYPT_Marshal,
#define RESPONSE_PARAMETER_LAST_TYPE    (TPM2B_KYBER_ENCRYPT_P_MARSHAL)
