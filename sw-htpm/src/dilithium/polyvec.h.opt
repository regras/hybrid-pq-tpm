...
#define polyvec_matrix_expand_and_multiply DILITHIUM_NAMESPACE(polyvec_matrix_expand_and_multiply)
void polyvec_matrix_expand_and_multiply(polyveck *t, const uint8_t rho[SEEDBYTES], poly *p, const polyvecl *v);
