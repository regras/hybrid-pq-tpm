...
extern "C" {
    ...
    LIB_EXPORT TPM_RC
    TSS_Array_Unmarshalu(BYTE *targetBuffer, UINT32 targetSize, BYTE **buffer, uint32_t *size);
    LIB_EXPORT TPM_RC
    TSS_TPM2B_Unmarshalu(TPM2B *target, UINT32 targetSize, BYTE **buffer, uint32_t *size);
    LIB_EXPORT TPM_RC
    ...
    TPM_RC TPMS_TAGGED_POLICY_Unmarshal(TPMS_TAGGED_POLICY *target, BYTE **buffer, UINT32 *size);
